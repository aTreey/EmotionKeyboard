#
#  Be sure to run `pod spec lint EmotionKeyboard.podspec' to ensure this is a
...
Swift Emotional Keyboard
  ...
  s.author             = { "HongpengYu" => "480814177@qq.com" }
  # Or just: s.author    = "HongpengYu"
  # s.authors            = { "HongpengYu" => "480814177@qq.com" }
  # s.social_media_url   = "http://twitter.com/HongpengYu"
